...
_HashmapChain_state InitializeHashmapChain(HashmapChain *x, int dataSize, int keySize, CompareFunction CmpFN,
                                           FreeFunction datafreeFN, FreeFunction keyfreeFN, Hash hashFn, mallocDatax MD,
                                           freeDatax FD) {
