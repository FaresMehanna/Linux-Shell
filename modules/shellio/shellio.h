 ...
 */
typedef enum {
    _shell_io_SUCC, _shell_io_MEMERR, _shell_io_ERR,
    _shell_io_LENGTHEXCED, _shell_io_END
} _shell_io_state;
typedef enum {
    _shell_io_msg_state_INFO, _shell_io_msg_state_WARNING,
    _shell_io_msg_state_ERROR
} shell_io_msg_state;
